...
class CapitulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capitulo" do
    assert_difference('Capitulo.count') do
      post capitulos_url, params: { capitulo: { name: @capitulo.name, serie_id: @capitulo.serie_id } }
    end
  ...
  test "should update capitulo" do
    patch capitulo_url(@capitulo), params: { capitulo: { name: @capitulo.name, serie_id: @capitulo.serie_id } }
