...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { name: @series.name, tipo_id: @series.tipo_id, user_id: @series.user_id, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { name: @series.name, tipo_id: @series.tipo_id, user_id: @series.user_id, year: @series.year } }
